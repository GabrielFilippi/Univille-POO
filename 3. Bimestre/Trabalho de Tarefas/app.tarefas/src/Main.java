...
public class Main {
	...
	public static void main(String[] args) {
		...
		InsertDb.inserirnoBD(); // comente esse usuario após a primeira rodagem do programa. pois esta estatico os id estrangeiros
	
		//mostramos o usuario a ser escolhido		
		UsuarioDAO userDao = new UsuarioDAO();
		System.out.println("Escolha qual é o seu usuario digitando o ID:");
		System.out.println();
		...
		while(menu!=9) {
			...
			System.out.println("======================================\n======================================");
			System.out.println();
			System.out.println("Escolha a opção Desejada (Digite o número):");
			System.out.println();
			...
			if(menu==1) {
				...
				System.out.println();
				System.out.println(nomeTarefa+" terá Sub-Tarefas? (1 = SIM; 2 = Não): ");
				...
				if(yesOrNo==1) {
					...
					while(insertSub==1) {
						...
						System.out.println();
						System.out.println("Deseja continuar cadastrando sub-tarefas? (1 = SIM; 9 = Não): ");
				...
				while(opcao!=9) {
					...
					if(opcao==1) {
						...
						scan.next();
						System.out.println("Digite o status da Tarefa 1 = Não realizado 2 = Realizado: ");
						...
						while(opcaoSub!=9) {
							...
							System.out.println("Deseja editar mais alguma Sub-Tarefa? Sim = 1 ou Não = 9");
				...
				while(opcao!=9) {
					...
					if(opcao==1) {
						...
						while(opcaoSub!=9) {
							...
							System.out.println("Deseja excluir mais alguma Sub-Tarefa? Sim = 1 ou Não = 9");
							opcaoSub = scan.nextInt();
						}
					}else if(opcao==9){
						break;
